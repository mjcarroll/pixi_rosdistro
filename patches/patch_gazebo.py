...
def patch_gz_vendor(package_path):
    ...
    # This file is sourced by the vendor package's own Config file.
    # It sets up paths and also creates RELAY config files for the inner package.
...
# Try various nested paths often used by Gazebo
